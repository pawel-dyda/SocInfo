...
public class Worker implements Employee {
	...
	public Worker(Organization organization, int employeeId, int hireWeek, double initialKnowledge, double selfPromotion,
			double learningRate) {
		_hireWeek = hireWeek;
	...
	public double getRealWorkPerformed() {
		if (isManager()) {
			Optional<Double> maybeSubordinatesWork = _organization.getSubordinates(this).stream()
